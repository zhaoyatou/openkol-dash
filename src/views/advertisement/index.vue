<template>
  <div>
    <el-button type="primary" @click="router.push(`/advertisement-detail`)"
      >创建</el-button
    >
        ...
        <template #default="scope">
          <el-row>
            <el-popconfirm
              ...
              @confirm="delAdvert(scope.row.id)"
            >
              <template #reference>
          ...
          <el-row>
            <el-button
              type="primary"
              @click="router.push(`/advertisement-detail?id=${scope.row.id}`)"
            >
              更新
            </el-button>
          </el-row>
...
<script setup>
import { delAdvertisement, getAdvertisementList } from "@/api/advertisement";
